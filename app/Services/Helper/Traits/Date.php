...
trait Date
{
     ...
     * @return string
     */
    public function dateAsTimezone(string $timezone, string $format = 'Y-m-d H:i:s'): string
    {
        return (new DateTime())->setTimezone($this->dateTimeZone($timezone))->format($format);
    }
