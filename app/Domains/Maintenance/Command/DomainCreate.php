...
class DomainCreate extends CommandAbstract
{
     ...
     * @var string
     */
    protected $signature = 'maintenance:domain:create {--name=} {--action} {--command} {--controller} {--exception} {--fractal} {--job} {--mail} {--middleware} {--model} {--schedule} {--seeder} {--test} {--validate}';
